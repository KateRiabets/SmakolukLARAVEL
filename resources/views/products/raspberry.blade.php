...
<div class="section_green">
    ...
    <div class="container_tovar">
        <div class="tovar_image">
            <img src="banki/swalina_d.png">
        </div>
        <div class="tovar_info">
            <h1>МАЛИНОВИЙ ДЖЕМ</h1>
            <img class="mobile-img-tovar" src="banki/swalina.png">
            <h3>130 грн</h3>

            <form method="POST" action="{{ route('add-to-cart', ['product' => 'raspberry']) }}">
                @csrf
    ...
    <div class="opis">
        <h2>ОПИС</h2>
        <p >Малиновий джем має насичений фруктовий аромат та соковитий смак. Він створений зі свіжих малин, які вирощуються в
            здоровому середовищі і збираються на піку їхньої зрілості. Цей джем чудово підійде для тих, хто любить насолоджуватися яскравими
            фруктовими смаками. Він виготовляється без додавання консервантів, штучних ароматизаторів та барвників, тому ви можете насолоджуватися його
            смаком з повною впевненістю в якості та натуральності.</p>
    </div>
