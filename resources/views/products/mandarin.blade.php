...
<div class="section_green">
    ...
    <div class="container_tovar">
        <div class="tovar_image">
            <img src="banki/swandarin_d.png">
        </div>
        <div class="tovar_info">
            <h1>МАНДАРИНОВИЙ ДЖЕМ</h1>
            <img class="mobile-img-tovar" src="banki/swandarin.png">
            <h3>130 грн</h3>

            <form method="POST" action="{{ route('add-to-cart', ['product' => 'mandarin']) }}">
                @csrf
    ...
    <div class="opis">
        <h2>ОПИС</h2>
        <p >Смак зими та нового року! Мандариновий джем - це поєднання свіжості та солодкості, яке дозволяє насолоджуватися
            ароматом свіжої цитрусової фруктової нотки. Він має насичений фруктовий смак та аромат, тому ідеально підійде як додаток до
            чаю або як смачну добавка до сніданку. </p>
    </div>
<div class="feedback">
