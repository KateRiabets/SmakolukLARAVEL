...
<div class="section_green">
    ...
    <div class="hamburger-menu">
        ...
        <ul class="menu_green__box">
            ...
            <li><a class="menu_green__item" href="contact">Контакти</a></li>
    ...
    <div class="container_tovar">
        <div class="tovar_image">
            <img src="banki/swakva_d.png">
        </div>
        <div class="tovar_info">
            <h1>ГАРБУЗОВИЙ ДЖЕМ</h1>
            <img class="mobile-img-tovar" src="banki/swakva.png">
            <h3>130 грн</h3>

            <form method="POST" action="{{ route('add-to-cart', ['product' => 'pumpkin']) }}">
                @csrf
    ...
    <div class="opis">
        <h2>ОПИС</h2>
        <p >Гарбуз користується заслуженою популярністю на всіх континентах. Як його тільки не готують: і відварюють, і запікають,
            і гасять, і їдять сирим, готують снеки, приправляють спеціями, травами, маслом і медом. Вона корисна в будь-якому вигляді
            для дорослих і дітей, а в нашому джемі – тим паче!</p>
    </div>
