...
{{--            лічильник--}}
    ...
    <div class="container_tovar">
        <div class="tovar_image">
            <img src="banki/sweach_d.png">
        </div>
        <div class="tovar_info">
            <h1>ПЕРСИКОВИЙ ДЖЕМ</h1>
            <img class="mobile-img-tovar" src="banki/sweach.png">
            <h3>149 грн</h3>


            <form method="POST" action="{{ route('add-to-cart', ['product' => 'peach']) }}">
                @csrf
    ...
    <div class="opis">
        <h2>ОПИС</h2>
        <p >Персикове варення – одне з найвишуканіших. Таким корисним ласощам раді дорослі та діти. Воно має приємний солодкий
            смак з легкою кислинкою, що робить його ідеальним вибором для сніданку або десерту. Якщо ви любите насолоджуватися свіжим
            та соковитим смаком, то персиковий джем - ідеальний вибір для вас.</p>
    </div>
