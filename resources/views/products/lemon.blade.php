...
<div class="section_green">
    ...
    <div class="container_tovar">
        <div class="tovar_image">
            <img src="banki/swalem_d.png">
        </div>
        <div class="tovar_info">
            <h1>ЛИМОННИЙ ДЖЕМ</h1>
            <img class="mobile-img-tovar" src="banki/swalem.png">
            <h3>149 грн</h3>

            <form method="POST" action="{{ route('add-to-cart', ['product' => 'lemon']) }}">
                @csrf
    ...
    <div class="opis">
        <h2>ОПИС</h2>
        <p >Екзотична новинка з дуже незвичайним кисло-солодким смаком. Цей джем має освіжаючий і трохи кислуватий смак лимону,
            що зробить будь-який сніданок більш насиченим і апетитним. Його аромат чудово підійде для тих, хто любить легкі фруктові запахи.</p>
    </div>
